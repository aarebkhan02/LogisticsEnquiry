...
function ServiceSelect({ selected, onChange }) {
  ...
  return (
    <div className="relative">
      <label className="mono-label text-[11px] font-bold text-[#3a5568]">SERVICE NEEDED *</label>
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="mt-2 flex w-full items-center justify-between border-b-2 border-[#bdb6a9] bg-transparent pb-3 pt-2 text-left transition-colors hover:border-[#2d827a] focus:outline-none"
      ...
      <div className="mx-auto grid max-w-[1440px] gap-16 lg:grid-cols-[0.72fr_1.28fr] lg:gap-28">
        ...
        <div className="bg-[#e8e5dc] p-6 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="grid gap-6 sm:grid-cols-2" data-testid="form-inquiry">
            <div className="sm:col-span-2"><label htmlFor="name" className="mono-label text-[11px] font-bold text-[#3a5568]">YOUR NAME *</label><input id="name" name="name" required placeholder="Avery Morgan" className="mt-2 w-full border-0 border-b-2 border-[#bdb6a9] bg-transparent px-0 py-3 text-base font-medium text-[#172f43] outline-none placeholder:text-[#597080]/70 focus:border-[#2d827a]" data-testid="input-inquiry-name" /></div>
            <div><label htmlFor="company" className="mono-label text-[11px] font-bold text-[#3a5568]">COMPANY *</label><input id="company" name="company" required placeholder="Company name" className="mt-2 w-full border-0 border-b-2 border-[#bdb6a9] bg-transparent px-0 py-3 text-base font-medium text-[#172f43] outline-none placeholder:text-[#597080]/70 focus:border-[#2d827a]" data-testid="input-inquiry-company" /></div>
            <div><label htmlFor="email" className="mono-label text-[11px] font-bold text-[#3a5568]">WORK EMAIL *</label><input id="email" name="email" type="email" required placeholder="you@company.com" className="mt-2 w-full border-0 border-b-2 border-[#bdb6a9] bg-transparent px-0 py-3 text-base font-medium text-[#172f43] outline-none placeholder:text-[#597080]/70 focus:border-[#2d827a]" data-testid="input-inquiry-email" /></div>
            <div><ServiceSelect selected={selectedService} onChange={onServiceChange} /></div>
            <div><label htmlFor="origin" className="mono-label text-[11px] font-bold text-[#3a5568]">ORIGIN</label><input id="origin" name="origin" placeholder="City / country" className="mt-2 w-full border-0 border-b-2 border-[#bdb6a9] bg-transparent px-0 py-3 text-base font-medium text-[#172f43] outline-none placeholder:text-[#597080]/70 focus:border-[#2d827a]" data-testid="input-inquiry-origin" /></div>
            <div><label htmlFor="destination" className="mono-label text-[11px] font-bold text-[#3a5568]">DESTINATION</label><input id="destination" name="destination" placeholder="City / country" className="mt-2 w-full border-0 border-b-2 border-[#bdb6a9] bg-transparent px-0 py-3 text-base font-medium text-[#172f43] outline-none placeholder:text-[#597080]/70 focus:border-[#2d827a]" data-testid="input-inquiry-destination" /></div>
            <div className="sm:col-span-2"><label htmlFor="message" className="mono-label text-[11px] font-bold text-[#3a5568]">WHAT ARE YOU MOVING?</label><textarea id="message" name="message" rows={3} placeholder="Cargo type, timing, special requirements..." className="mt-2 w-full resize-none border-0 border-b-2 border-[#bdb6a9] bg-transparent px-0 py-3 text-base font-medium text-[#172f43] outline-none placeholder:text-[#597080]/70 focus:border-[#2d827a]" data-testid="textarea-inquiry-message" /></div>
